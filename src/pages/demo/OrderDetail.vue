                ...
                state.turnovers = [
                    {
                        ...
                        ratio: '较昨日比例50%',
                        image: require('@/assets/img/demo/icon/order-detail-1.png')
                    },
                    {
                        price: '120',
                        todayNum: '今日成交数1002单',
                        yesterdayNum: '昨日成交数15624单',
                        ratio: '较昨日比例50%',
                        image: require('@/assets/img/demo/icon/order-detail-2.png')
                    },
                    {
                        price: '520',
                        todayNum: '今日成交数1002单',
                        yesterdayNum: '昨日成交数15624单',
                        ratio: '较昨日比例50%',
                        image: require('@/assets/img/demo/icon/order-detail-3.png')
                    }
                ]
            })

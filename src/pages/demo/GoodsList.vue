    ...
    export default {
        setup() {
            ...
            const init = () =>{
                ...
                state.tableData = [
                    {goodsId: '10001', goodsName: '饼干-案件韩国大受打击会是大分公司丢案发把速度告发送', coverImg: require('@/assets/img/demo/login/logo.png'),stock:'1000',goodsPrice:'12.58',categoryName:'食品',status:'1',updateTime:'2016-05-02 12:20:21'},
                    {goodsId: '10001', goodsName: '饼干', coverImg: require('@/assets/img/demo/login/logo.png'),stock:'1000',goodsPrice:'12.58',categoryName:'食品',status:'0',updateTime:'2016-05-02 12:20:21'},
                ]

            ...
            <el-row :gutter="20">
                <el-col :span="6" v-for="(card,c) in cards" :key="c">
                    <el-card shadow="always">
                        <el-row>
                            <el-col :span="4">
                                <el-image style="width: 60px; height: 60px" v-if="c == 0" :src="require('@/assets/img/demo/icon/kpi.png')"/>
                                <el-image style="width: 60px; height: 60px" v-else-if="c == 1" :src="require('@/assets/img/demo/icon/zc.png')"/>
                                <el-image style="width: 60px; height: 60px" v-else-if="c == 2" :src="require('@/assets/img/demo/icon/zzl.png')"/>
                                <el-image style="width: 60px; height: 60px" v-else-if="c == 3" :src="require('@/assets/img/demo/icon/htl.png')"/>
                            </el-col>
        ...
        <div class="home-chart m120">
            <el-row :gutter="20">
                ...
                <el-col :span="18">
                    <el-card shadow="always">
                        <template #header>
                            <el-image class="icon" :src="require('@/assets/img/demo/icon/histogram.png')"/>
                    ...
                    <el-card class="m120" shadow="always">
                        <template #header>
                            <el-image class="icon" :src="require('@/assets/img/demo/icon/list.png')"/>
                ...
                <el-col :span="6">
                    <el-card shadow="always">
                        <template #header>
                            <el-image class="icon" :src="require('@/assets/img/demo/icon/pie.png')"/>
                    ...
                    <el-card class="m120" shadow="always">
                        <template #header>
                            <el-image class="icon" :src="require('@/assets/img/demo/icon/satisfaction.png')"/>
    ...
    export default {
        setup() {
            const state = reactive({
                avatar: require('@/assets/img/demo/login/logo.png'),
                deal: require('@/assets/img/demo/icon/成交.png'),
                money: require('@/assets/img/demo/icon/人民币.png'),
                cards: [],
                overviewOption: {},
                date: '',
                payTypeOPtion: {},
            ...
            onMounted(() => {
                ...
                state.cards = [
                    {icon: require('@/assets/img/demo/icon/kpi.png'), price: '15000', ratio: '87', type: '总收入'},
                    {icon: require('@/assets/img/demo/icon/zc.png'), price: '15000', ratio: '87', type: '总费用'},
                    {icon: require('@/assets/img/demo/icon/zzl.png'), price: '15000', ratio: '87', type: '总增长'},
                    {icon: require('@/assets/img/demo/icon/htl.png'), price: '15000', ratio: '87', type: '退回率'}
                ]
                ...
                // 客户满意度
                state.satisfactions = [
                    {num: '20142', image: require('@/assets/img/demo/icon/开心.png'), message: '五星及以上评论', ratio: '60'},
                    {num: '12455', image: require('@/assets/img/demo/icon/笑脸.png'), message: '三星及以上评论', ratio: '36'},
                    {num: '12', image: require('@/assets/img/demo/icon/难过.png'), message: '二星及以下评论', ratio: '4'}
                ]
